...
#     op.add_column('workload_request_decision', sa.Column('decision_status', sa.Enum('pending', 'successful', 'failed', name='workload_request_decision_status_enum'), nullable=False))
...
#     """Downgrade schema."""
#     # ### commands auto generated by Alembic - please adjust! ###
#     op.add_column('workload_request_decision', sa.Column('is_decision_status', sa.BOOLEAN(), autoincrement=False, nullable=False))
