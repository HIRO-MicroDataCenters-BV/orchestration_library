...
def record_workload_timing_metrics(
    metrics_details: Dict[str, Any],
    status_code: int,
    exception: Optional[Exception] = None,
):
    """
    Record metrics for workload timing API requests.
    ...
    record_api_metrics(
        ...
        status_code=status_code,
        exception=exception,
        counter_metrics=[workload_timing_requests_total],
        histogram_metrics=[workload_timing_requests_latency_seconds],
    )
