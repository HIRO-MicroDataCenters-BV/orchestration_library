...
# Workload Flow API
wrokload_flow_requests_total = Counter(
    "wrokload_flow_requests_total",
    "Total number of workload flow API requests",
    ["method", "endpoint", "status_code"]
)
wrokload_flow_requests_latency_seconds = Histogram(
    "wrokload_flow_requests_latency_seconds",
