...
POD_PARENT_TYPE_ENUM = ('Deployment', 'StatefulSet', 'ReplicaSet', 'Job', 'DaemonSet', 'CronJob')
...
class WorkloadAction(Base, BaseDictMixin):
    ...
    pod_parent_name = Column(String, nullable=True, doc="Name of the pod's parent resource")
    pod_parent_type = Column(
        Enum(*POD_PARENT_TYPE_ENUM, name="pod_parent_type_enum"),
        nullable=True,
        doc="Type of the pod's parent resource"
    )
    pod_parent_uid = Column(UUID(as_uuid=True), nullable=True, doc="UID of the pod's parent resource")

    created_pod_name = Column(String, nullable=True, doc="Name of the created pod")
    created_pod_namespace = Column(String, nullable=True, doc="Namespace of the created pod")
    created_node_name = Column(String, nullable=True, doc="Node name where the pod was created")

    deleted_pod_name = Column(String, nullable=True, doc="Name of the deleted pod")
    deleted_pod_namespace = Column(String, nullable=True, doc="Namespace of the deleted pod")
    deleted_node_name = Column(String, nullable=True, doc="Node name where the pod was deleted")

    bound_pod_name = Column(String, nullable=True, doc="Name of the bound pod")
    bound_pod_namespace = Column(String, nullable=True, doc="Namespace of the bound pod")
    bound_node_name = Column(String, nullable=True, doc="Node name where the pod was bound")
