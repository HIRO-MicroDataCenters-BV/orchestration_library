...
@pytest.mark.asyncio
@patch(
    "app.repositories.workload_request_decision.create_workload_request_decision",
...
@pytest.mark.asyncio
@patch(
    "app.repositories.workload_request_decision.update_workload_request_decision",
    new_callable=AsyncMock,
)
...
@pytest.mark.asyncio
@patch(
    "app.repositories.workload_request_decision.delete_workload_request_decision",
    new_callable=AsyncMock,
)
...
@pytest.mark.asyncio
@patch(
    "app.repositories.workload_request_decision.get_workload_request_decision",
    new_callable=AsyncMock,
)
