...
OBSERVABILITY_NAMESPACE="aces-monitoring-observability"
WAM_NAMESPACE="ul"
...
ALERTS_POPULATOR_NATS_SERVER=nats://nats-server.$OBSERVABILITY_NAMESPACE.svc.cluster.local:4222
...
ALERT_ACTION_TRIGGER_SERVICE_URL="http://wam-app.$WAM_NAMESPACE.svc.cluster.local:3030/rpc"
# ALERT_ACTION_TRIGGER_SERVICE_URL="http://localhost:3030/rpc" # For local testing with port-forwarding

KPI_METRICS_NATS_SERVER=nats://nats-server.$OBSERVABILITY_NAMESPACE.svc.cluster.local:4222
...
TUNING_PARAMETERS_POPULATOR_NATS_SERVER=nats://nats-server.$OBSERVABILITY_NAMESPACE.svc.cluster.local:4222
TUNING_PARAMETERS_POPULATOR_NATS_JS_STREAM="HP3"
TUNING_PARAMETERS_POPULATOR_NATS_JS_SUBJECTS=("hp3.predictions", "hp3")
TUNING_PARAMETERS_POPULATOR_NATS_JS_DURABLE="tuning-parameters-populator"
TUNING_PARAMETERS_POPULATOR_TUNING_PARAMETERS_API_URL="http://$ORCHRESTRATION_API_APP_NAME.$ORCHRESTRATION_API_NAMESPACE.svc.cluster.local:$ORCHRESTRATION_API_SERVICE_PORT/tuning_parameters"
...
helm_command="""helm upgrade --install $ORCHRESTRATION_API_RELEASE_NAME ./charts/orchestration-api \
  ...
  --set app.env.ALERT_ACTION_TRIGGER_SERVICE_URL=$ALERT_ACTION_TRIGGER_SERVICE_URL \
