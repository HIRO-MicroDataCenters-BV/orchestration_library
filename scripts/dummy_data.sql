...
INSERT INTO workload_request_decision (
    ...
    demand_cpu, demand_memory, demand_slack_cpu, demand_slack_memory, is_decision_status,
    pod_parent_id, pod_parent_name, pod_parent_kind, created_at, deleted_at
) VALUES
('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '11111111-1111-1111-1111-111111111111', 'pod-x', 'ns-x', '22222222-2222-2222-2222-222222222222', 'node-x', TRUE, 'queue-x',
