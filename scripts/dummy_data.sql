...
-- alerts table
INSERT INTO alerts (
    alert_type, alert_level, alert_model, alert_description, pod_id, node_id,
    source_ip, source_port, destination_ip, destination_port, protocol, created_at
) VALUES
('Abnormal', 'Warning', 'ModelA', 'CPU spike', '11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
 '10.0.0.1', 8080, '10.0.0.2', 80, 'TCP', '2024-07-31 12:00:00'),
('Network-Attack', 'Critical', 'ModelB', 'Network anomaly', '33333333-3333-3333-3333-333333333333', '44444444-4444-4444-4444-444444444444',
 '192.168.1.10', 443, '192.168.1.20', 443, 'UDP', '2024-07-30 12:00:00'),
('Other', 'Warning', 'ModelC', 'SQL Injection', '55555555-5555-5555-5555-555555555555', '66666666-6666-6666-6666-666666666666',
...
('dd44dd44-dd44-dd44-dd44-dd44dd44dd44','move','pending','2025-09-17 13:00:00','2025-09-17 13:00:01','Move test',
 ...
 NULL, NULL,'move-node',
 'move-pod','move-ns','move-node-old',
 NULL,NULL,NULL,
...
INSERT INTO kpi_metrics (request_decision_id, node_name, cpu_utilization, mem_utilization, decision_time_in_seconds, created_at) VALUES
('11111111-1111-1111-1111-111111111111', 'node1', 0.42, 0.55, 0.120, '2025-10-23 09:00:00+00'),
('11111111-1111-1111-1111-111111111111', 'node2', 0.33, 0.61, 0.0, '2025-10-23 09:00:05+00'),
('11111111-1111-1111-1111-111111111111', 'node3', 0.77, 0.82, 0.0, '2025-10-23 09:00:10+00'),

('22222222-2222-2222-2222-222222222222', 'node1', 0.50, 0.57, 0.0, '2025-10-23 10:00:00+00'),
('22222222-2222-2222-2222-222222222222', 'node2', 0.40, 0.63, 0.100, '2025-10-23 10:00:05+00'),
('22222222-2222-2222-2222-222222222222', 'node3', 0.69, 0.80, 0.0, '2025-10-23 10:00:10+00'),

('33333333-3333-3333-3333-333333333333', 'node1', 0.47, 0.52, 0.0, '2025-10-23 11:00:00+00'),
('33333333-3333-3333-3333-333333333333', 'node2', 0.38, 0.58, 0.0, '2025-10-23 11:00:05+00'),
('33333333-3333-3333-3333-333333333333', 'node3', 0.72, 0.78, 0.170, '2025-10-23 11:00:10+00'),

('44444444-4444-4444-4444-444444444444', 'node1', 0.44, 0.50, 0.118, '2025-10-23 12:00:00+00'),
('44444444-4444-4444-4444-444444444444', 'node2', 0.36, 0.54, 0.0, '2025-10-23 12:00:05+00'),
('44444444-4444-4444-4444-444444444444', 'node3', 0.68, 0.76, 0.0, '2025-10-23 12:00:10+00');